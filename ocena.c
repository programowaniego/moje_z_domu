...
int ocena_pozycji(plansza* stol){
    ...
    for(int i = 0;i < wiersze * kolumny; i++){
        ...
        if(stol->wartosci[i] == stol->gracz_na_ruchu && ile_pionkow(stol,stol->gracz_na_ruchu) < (wiersze * kolumny - wiersze * kolumny % 13) / 13) //liczymy tylko dla malej liczny pionkow
